...
Tune more parameters of the model. You can find a description of all the parameters you can tune in the scikit-learn documentation – for example Random Forest Classifier documentation. See what happens if you tune max_features or n_estimators.
